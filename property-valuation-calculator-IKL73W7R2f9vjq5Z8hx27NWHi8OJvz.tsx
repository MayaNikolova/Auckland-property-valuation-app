                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-green-600">{suburbReport.region} • Updated {new Date(suburbReport.lastUpdated).toLocaleDateString()}</p>
                        </div>
                      </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-green-200">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold">{suburbReport.marketTrends.salesVolume} properties</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className={`font-semibold ${suburbReport.marketTrends.priceGrowth12Months >= 0 ? 'text-green-700' : 'text-red-700'}`}>
                                {suburbReport.marketTrends.priceGrowth12Months >= 0 ? '+' : ''}{suburbReport.marketTrends.priceGrowth12Months}%
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-green-200">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold">${(suburbReport.averageRentalPrice * 52).toLocaleString()}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-green-200">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold">{suburbReport.demographics.population.toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">Households:</span>
                              <span className="font-semibold">{suburbReport.demographics.households.toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold">${suburbReport.demographics.medianIncome.toLocaleString()}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-6 bg-white rounded-lg p-4 border border-green-200">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-sm">
                          {Object.entries(suburbReport.demographics.ethnicityBreakdown).map(([ethnicity, percentage]) => (
                      ...
                      <div className="mt-6 p-4 bg-white rounded-lg border border-green-200">
                        ...
                        <p className="text-xs text-gray-600">
                          ...
                          Rental data: TradeMe Property, Tenancy Services • Amenity data: Auckland Council, Google Maps
                        </p>
                      </div>
                    </CardContent>
                  </Card>
